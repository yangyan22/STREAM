...
from dataset.data_helper_multiviews import create_datasets
import torch
...
class DataModule(LightningDataModule):
    ...
    def val_dataloader(self):
        ...
        loader = DataLoader(self.dataset["test"], batch_size=self.args.val_batch_size, drop_last=True, pin_memory=True,
                            num_workers=self.args.num_workers, prefetch_factor=self.args.prefetch_factor)   
        return loader
