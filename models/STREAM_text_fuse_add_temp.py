...
#     return return_data
    def forward(self, samples):
        ...
        retriver_text_embed, _ = self.encode_text(retriver_text, query_feature)  
        retriver_text_embed = self.iit_proj(retriver_text_embed)
        retriver_text_embed = self.iit_layernorm(retriver_text_embed)  
        new_embeds = torch.cat([img_embeds, retriver_text_embed], dim=2)  
